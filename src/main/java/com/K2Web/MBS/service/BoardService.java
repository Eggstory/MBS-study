...
import com.K2Web.MBS.dto.ReplySaveRequestDto;
import com.K2Web.MBS.model.Board;
import com.K2Web.MBS.model.User;
import com.K2Web.MBS.repository.BoardRepository;
import com.K2Web.MBS.repository.ReplyRepository;
...
*/
	...
	//실패코드 (검색기능)
	/*
	 * public List getSearchList(BoardDto boardDto) throws Exception { return
	 * boarddao.selectSearchList(boardDto); }
	 * 
	 * public List<BoardDto> selectSearchList(BoardDto boardDto) throws Exception {
